          ...
          {chartType === 'donut' ? (
            ...
            <div className="w-full space-y-2 py-2">
              <span className="text-xs font-bold text-[#145A52] block text-center">
                Distribuição de Progresso ({percentage}%)
              </span>
              ...
              <div className="flex items-center justify-center gap-4 text-xs">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[#1C2826] font-medium">Concluídas ({completedCount})</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="w-3 h-3 rounded-full bg-[#E2DDD5]" />
                  <span className="text-[#62726F] font-medium">Pendentes ({pendingCount})</span>
                </div>
              </div>
            </div>
          )}
      ...
      {isAdding && (
        <form onSubmit={handleAddSubtask} className="bg-[#F7F5F1] p-3.5 rounded-2xl border border-[#E2DDD5] flex items-center gap-2">
          <input
            ...
            placeholder="Digite a descrição da nova sub-tarefa..."
      ...
      <div className="space-y-2 pt-1">
        {subtasks.length > 0 ? (
          ...
          <div className="text-center py-4 bg-[#F7F5F1]/50 rounded-2xl border border-dashed border-[#E2DDD5] text-xs text-[#62726F]">
            Nenhuma sub-tarefa cadastrada para este caso ainda. Clique em "Adicionar Sub-tarefa" para iniciar o mapeamento por etapas.
          </div>
        )}
      </div>
